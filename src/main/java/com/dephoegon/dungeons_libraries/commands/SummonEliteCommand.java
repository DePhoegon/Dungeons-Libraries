package com.dephoegon.dungeons_libraries.commands;

import com.dephoegon.dungeons_libraries.entities.elite.EliteMobEvents;
...
public class SummonEliteCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138815_) {
      p_138815_.register(Commands.literal("summonelite").requires((p_138819_) -> {
