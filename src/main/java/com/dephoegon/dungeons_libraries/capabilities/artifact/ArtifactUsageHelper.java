package com.dephoegon.dungeons_libraries.capabilities.artifact;

import net.minecraft.world.entity.Entity;
import net.minecraft.world.entity.player.Player;
import net.minecraft.world.item.ItemStack;

import static com.dephoegon.dungeons_libraries.capabilities.ModCapabilities.ARTIFACT_USAGE_CAPABILITY;
