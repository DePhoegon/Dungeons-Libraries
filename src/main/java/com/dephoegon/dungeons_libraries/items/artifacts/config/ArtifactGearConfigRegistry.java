package com.dephoegon.dungeons_libraries.items.artifacts.config;

import com.dephoegon.dungeons_libraries.data.util.CodecJsonDataManager;
import com.dephoegon.dungeons_libraries.network.gearconfig.ArtifactGearConfigSyncPacket;
